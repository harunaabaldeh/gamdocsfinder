        ...
        <div className="bg-white dark:bg-gray-900">
            <div className="bg-white relative pt-40 pb-20 lg:pt-44 dark:bg-gray-900">
                <div className="relative xl:container m-auto px-6 md:px-12 lg:px-6">
                    <h1 className="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-4xl text-center sm:text-5xl md:text-6xl lg:w-auto lg:text-left xl:text-7xl dark:text-white">look up and help somebody find<br className="lg:block hidden" /> <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-blue-400 dark:to-cyan-300">their documents</span>.</h1>
                    <div className="lg:flex">
                        <div className="relative mt-8 md:mt-16 space-y-8 sm:w-10/12 md:w-2/3 lg:ml-0 sm:mx-auto text-center lg:text-left lg:mr-auto lg:w-7/12">
                            <p className="sm:text-lg text-gray-700 dark:text-gray-300 lg:w-11/12">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nisi saepe rerum repudiandae dolor fugiat reprehenderit ex error, voluptas fugit! Dolores minus vero autem ex minima cumque quae iste, veniam ducimus.
                            </p>

                            <span className="block font-semibold text-gray-500 dark:text-gray-400">You're one click away from reaching us at</span>
